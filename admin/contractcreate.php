...
elseif ($request == 'POST') {
    ...
    $query = "insert into ".$db_prefix."contracts (daily_hours, typre_contracts, overtime_cost) values ('".$post_contractname."', '".$post_dailyhours."', '".$post_overtime."')";
    $result = mysqli_query($GLOBALS["___mysqli_ston"], $query);
