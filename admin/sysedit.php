...
// Ensure we can make changes to the configuration file
if (!is_readable($filename)) {
    ...
    // If the operating system is not Windows display who owns the file.
    if(PHP_OS != 'WIN32') {
...
*/
    ...
    // Inform a user if he is not able to write the configuration file.
    ...
    if ($over_time_hour < 0) { // Ensure that the over time value is legit
        echo "
            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>
               <tr>
                  <td width=20 align=center height=25 class=table_rows>
                     <img src='../images/icons/cancel.png' />
                  </td>
                  <td class=table_rows_red height=25>
                     <b>over_time_hour</b> is not a valid time limit.
                  </td>
                </tr>
            </table>
            <br />\n";
...
//      } elseif ((!eregi ("^(#[a-fA-F0-9]{6})+$", $color2)) && (!eregi ("^([a-fA-F0-9]{6})+$", $color2))) {
        ...
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>company_name</b> is longer than the allowed 100 characters.</td></tr>\n";
        echo "            </table>\n";
        $evil = "1";
        echo "            <br />\n";
...
//        } elseif ((!eregi ("^([0-9]?[0-9])+:+([0-9]+[0-9])+([a|p]+m)$", $report_end_time, $end_time_regs)) && (!eregi ("^([0-9]?[0-9])+:+([0-9]+[0-9])+( [a|p]+m)$", $report_end_time, $end_time_regs)) && (!eregi ("^([0-9]?[0-9])+:+([0-9]+[0-9])$", $report_end_time, $end_time_regs))) {
    ...
    if ($use_persistent_connection == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_persistent_connection\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"use_persistent_connection\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($use_persistent_connection == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_persistent_connection\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"use_persistent_connection\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
    ...
    // User log-in password usage
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>use_passwd:</td>\n";
    if ($use_passwd == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_passwd\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"use_passwd\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($use_passwd == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_passwd\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"use_passwd\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($use_reports_password == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_reports_password\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"use_reports_password\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($use_reports_password == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_reports_password\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"use_reports_password\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($restrict_ips == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"restrict_ips\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"restrict_ips\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($restrict_ips == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"restrict_ips\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"restrict_ips\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($ip_logging == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"ip_logging\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"ip_logging\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($ip_logging == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"ip_logging\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"ip_logging\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($disable_sysedit == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"disable_sysedit\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"disable_sysedit\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    $row_count = '0'; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display required Time Admin edit reason
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>require_time_admin_edit_reason:</td>\n";
    if ($require_time_admin_edit_reason == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($require_time_admin_edit_reason == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"require_time_admin_edit_reason\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>This provides the requirement for the time admin to input a reason for an edit to an employee's time record. Default is \"<b>yes</b>\".</td></tr>\n";
    ...
    if ($tmp_datefmt == "d.m.yyyy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"1\" checked />&nbsp;d.m.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"2\" />&nbsp;d/m/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"3\" />&nbsp;d-m-yyyy</td></tr>\n";
    } elseif ($tmp_datefmt == "d/m/yyyy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"1\" />&nbsp;d.m.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"2\" checked />&nbsp;d/m/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"3\" />&nbsp;d-m-yyyy</td></tr>\n";
    } elseif ($tmp_datefmt == "d-m-yyyy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"1\" />&nbsp;d.m.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"2\" />&nbsp;d/m/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"3\" checked />&nbsp;d-m-yyyy</td></tr>\n";
    } else {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"1\" />&nbsp;d.m.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"2\" />&nbsp;d/m/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"3\" />&nbsp;d-m-yyyy</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($tmp_datefmt == "d.m.yy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"4\" checked />&nbsp;d.m.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"5\" />&nbsp;d/m/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"6\" />&nbsp;d-m-yy</td></tr>\n";
    } elseif ($tmp_datefmt == "d/m/yy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"4\" />&nbsp;d.m.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"5\" checked />&nbsp;d/m/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"6\" />&nbsp;d-m-yy</td></tr>\n";
    } elseif ($tmp_datefmt == "d-m-yy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"4\" />&nbsp;d.m.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"5\" />&nbsp;d/m/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"6\" checked />&nbsp;d-m-yy</td></tr>\n";
    } else {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"4\" />&nbsp;d.m.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"5\" />&nbsp;d/m/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"6\" />&nbsp;d-m-yy</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($tmp_datefmt == "m.d.yyyy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"7\" checked />&nbsp;m.d.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"8\" />&nbsp;m/d/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"9\" />&nbsp;m-d-yyyy</td></tr>\n";
    } elseif ($tmp_datefmt == "m/d/yyyy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"7\" />&nbsp;m.d.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"8\" checked />&nbsp;m/d/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"9\" />&nbsp;m-d-yyyy</td></tr>\n";
    } elseif ($tmp_datefmt == "m-d-yyyy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"7\" />&nbsp;m.d.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"8\" />&nbsp;m/d/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"9\" checked />&nbsp;m-d-yyyy</td></tr>\n";
    } else {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"7\" />&nbsp;m.d.yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"8\" />&nbsp;m/d/yyyy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"9\"  />&nbsp;m-d-yyyy</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($tmp_datefmt == "m.d.yy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"10\" checked />&nbsp;m.d.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"11\" />&nbsp;m/d/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"12\" />&nbsp;m-d-yy</td></tr>";
    } elseif ($tmp_datefmt == "m/d/yy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=15% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"10\" />&nbsp;m.d.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=15% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"11\" checked />&nbsp;m/d/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=70% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"12\" />&nbsp;m-d-yy</td></tr>";
    } elseif ($tmp_datefmt == "m-d-yy") {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"10\" />&nbsp;m.d.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"11\" />&nbsp;m/d/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"12\" checked />&nbsp;m-d-yy</td></tr>";
    } else {
        echo "              <tr><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"10\" />&nbsp;m.d.yy</td><td nowrap bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <input type=\"radio\" name=\"tmp_datefmt\" value=\"11\" />&nbsp;m/d/yy</td><td nowrap bgcolor='$row_color' class=table_rows width=80% align=left valign=top><input type=\"radio\" name=\"tmp_datefmt\" value=\"12\" />&nbsp;m-d-yy</td></tr>";
    }
    if (($tmp_datefmt != "d.m.yyyy") && ($tmp_datefmt != "d/m/yyyy") && ($tmp_datefmt != "d-m-yyyy") && ($tmp_datefmt != "d.m.yy") && ($tmp_datefmt != "d/m/yy") && ($tmp_datefmt != "d-m-yy") && ($tmp_datefmt != "m.d.yyyy") && ($tmp_datefmt != "m/d/yyyy") && ($tmp_datefmt != "m-d-yyyy") && ($tmp_datefmt != "m.d.yy") && ($tmp_datefmt != "m/d/yy") && ($tmp_datefmt != "m-d-yy")) {
        echo "              <tr><td colspan=3 valign=bottom height=30 bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>A valid Date Format has not been chosen in config.inc.php!! Choose one from above.</b></td></tr>\n";
    }
    echo "</table></td></tr>\n";
    $row_count = '0'; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Time Display format
    echo "              <tr><td height=25 valign=bottom colspan=3 class=table_rows width=10% align=left style='padding-left:4px;'><u>Time Format:</u></td></tr>\n";
    if ($timefmt == "G:i") {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"1\" checked />24 hour format without leading zeroes</td></tr>\n";
    } else {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"1\" />24 hour format without leading zeroes</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($timefmt == "H:i") {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"2\" checked />24 hour format with leading zeroes</td></tr>\n";
    } else {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"2\" />24 hour format with leading zeroes</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($timefmt == "g:i A") {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"3\" checked />12 hour format with uppercase am/pm indicator, including a space between the minutes and meridiems</td></tr>\n";
    } else {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"3\" />12 hour format with uppercase am/pm indicator, including a space between the minutes and meridiems</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($timefmt == "g:i a") {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"4\" checked />12 hour format with lowercase am/pm indicator, including a space between the minutes and meridiems</td></tr>\n";
    } else {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"4\" />12 hour format with lowercase am/pm indicator, including a space between the minutes and meridiems</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($timefmt == "g:iA") {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"5\" checked />12 hour format with uppercase am/pm indicator, no space between the minutes and meridiems</td></tr>\n";
    } else {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"5\" />12 hour format with uppercase am/pm indicator, no space between the minutes and meridiems</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ($timefmt == "g:ia") {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"6\" checked />12 hour format with lowercase am/pm indicator, no space between the minutes and meridiems</td></tr>\n";
    } else {
        echo "              <tr><td colspan=3 bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"timefmt\" value=\"6\" />12 hour format with lowercase am/pm indicator, no space between the minutes and meridiems</td></tr>\n";
    }
    if (($timefmt != "G:i") && ($timefmt != "H:i") && ($timefmt != "g:i A") && ($timefmt != "g:i a") && ($timefmt != "g:iA") && ($timefmt != "g:ia")) {
        echo "              <tr><td colspan=3 valign=bottom height=30 bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>A valid Time Format has not been chosen in config.inc.php!! Choose one from above.</b></td></tr>\n";
    }
    $row_count = '0'; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Report options
    echo "              <tr><td nowrap style='border:solid #888888;border-width:0px 0px 1px 0px;' colspan=3>&nbsp;</td></tr>\n";
    ...
    if ($round_time == '3') {
        ...
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=20% align=left valign=top nowrap><input type=\"radio\" name=\"round_time\" value=\"3\" />&nbsp;To the nearest 15 minutes (1/4th of an hour)</td><td bgcolor='$row_color' class=table_rows width=80% align=left valign=top> <input type=\"radio\" name=\"round_time\" value=\"0\" />&nbsp;Do not round.</td></tr>\n";
    }
    $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
    if ((!empty($round_time)) && ($round_time != '1') && ($round_time != '2') && ($round_time != '3') && ($round_time != '4') && ($round_time != '5')) {
        echo "              <tr><td colspan=3 valign=bottom height=30 bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top style='padding-left:5px;'><b>A valid Rounding Method has not been chosen in config.inc.php!! Choose one from above.</b></td></tr>\n";
    }
    echo "            </table></td></tr>\n";
    ...
    if ($paginate == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"paginate\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"paginate\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($paginate == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"paginate\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"paginate\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($show_details == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"show_details\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"show_details\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($show_details == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"show_details\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"show_details\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($username_dropdown_only == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"username_dropdown_only\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"username_dropdown_only\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($username_dropdown_only == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"username_dropdown_only\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"username_dropdown_only\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // User-name or display name option
    ...
    if (strtolower($user_or_display) == "user") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"user_or_display\" value=\"1\" checked />&nbsp;User<input type=\"radio\" name=\"user_or_display\" value=\"0\" />&nbsp;Display</td>\n";
    } elseif (strtolower($user_or_display) == "display") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"user_or_display\" value=\"1\" />&nbsp;User<input type=\"radio\" name=\"user_or_display\" value=\"0\" checked />&nbsp;Display</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"User\" or \"Display\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if (strtolower($display_ip) == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_ip\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"display_ip\" value=\"0\" />&nbsp;No</td>\n";
    } elseif (strtolower($display_ip) == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_ip\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"display_ip\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if (strtolower($export_csv) == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"export_csv\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"export_csv\" value=\"0\" />&nbsp;No</td>\n";
    } elseif (strtolower($export_csv) == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"export_csv\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"export_csv\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"export_csv\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Choose \"<b>yes</b>\" to export the reports to a comma delimited file (.csv). Default is \"<b>no</b>\".</td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Over time hours
    echo "
              <tr>
                ...
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='text' name='over_time_hour' value='$over_time_hour' />
                </td>
    ...
    // Use client timezone option
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>use_client_tz:</td>\n";
    if ($use_client_tz == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_client_tz\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"use_client_tz\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($use_client_tz == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_client_tz\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"use_client_tz\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"use_client_tz\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Setting this option to \"yes\" will display the punch-in/out times according to the timezone of the connecting computer, providing javascript is enabled in the user's browser. Default is \"<b>no</b>\". </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Use server timezone option
    ...
    if ($use_server_tz == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_server_tz\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"use_server_tz\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($use_server_tz == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_server_tz\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"use_server_tz\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
    ...
    if ($display_current_users == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_current_users\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"display_current_users\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($display_current_users == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_current_users\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"display_current_users\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"display_current_users\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Display only the current day's activity instead of the last entry from each user. Default is \"<b>no</b>\". </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    ...
    if ($show_display_name == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"show_display_name\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"show_display_name\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($show_display_name == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"show_display_name\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"show_display_name\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"show_display_name\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Show a user's Display Name instead of their username on the main page. Default is \"<b>no</b>\". </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display office
    echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>display_office:</td>\n";
    echo "                     <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <select name='office_name' onchange='group_names();'> <option selected>$display_office</option>\n";
    echo "                      </select></td>\n";
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Display a certain office on the main page of the application, instead of all the users. Default is \"<b>all</b>\". </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display group
    ...
    if (($display_office == "all") || ($display_office == "All")) {
        ...
        echo "                     <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <select name='group_name' onfocus='group_names();'> <option selected>$display_group</option>\n";
        echo "                      </select></td>\n";
    }
    ...
    if ($display_office_name == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_office_name\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"display_office_name\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($display_office_name == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_office_name\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"display_office_name\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"display_office_name\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Display a column on the main page that shows the office each user is affiliated with. Default is \"<b>no</b>\". </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display group names
    ...
    if ($display_group_name == "yes") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_group_name\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"display_group_name\" value=\"0\" />&nbsp;No</td>\n";
    } elseif ($display_group_name == "no") {
        echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"display_group_name\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"display_group_name\" value=\"0\" checked />&nbsp;No</td>\n";
    } else {
        echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
        echo "              <input type=\"hidden\" name=\"display_group_name\" value=\"2\">\n";
    }
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Display a column on the main page that shows the group each user is affiliated with. Default is \"<b>no</b>\". </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display weather
    ...
    echo "                  </td>\n";
    echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>These are links to websites, other web-based applications, etc., that you wish to display in the topleft of the application just below the logo. To display these links accordingly, use the 'display_links' option in conjunction with this option. To add more than 10 links, you will need to add them manually in config.inc.php. Leave all 10 blanks empty to ignore this option. </td></tr>\n";
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display the links
    ...
    if ($display_name == "yes") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_name' checked='true' />
                </td>";
    } else {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
    ...
    if ($display_status == "yes") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_status' checked='true' />
                </td>";
    } else {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
    ...
    $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
    // Display column status options
    echo "
              <tr>
                 <td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>
                    display_status_option:
                </td>";
    if ($display_status_option == "icon") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='radio' name='display_status_option' value='icon' checked='true'>
                      Icon
                   </input>
                   <input type='radio' name='display_status_option' value='text'>
                      Text
                   </input>
                   <input type='radio' name='display_status_option' value='both'>
                      Both
                   </input>
                </td>";
    } else if ($display_status_option == "text") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='radio' name='display_status_option' value='icon'>
                      Icon
                   </input>
                   <input type='radio' name='display_status_option' value='text' checked='true'>
                      Text
                   </input>
                   <input type='radio' name='display_status_option' value='both'>
                      Both
    ...
    } else if ($display_status_option == "both") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='radio' name='display_status_option' value='icon'>
                      Icon
                   ...
                   <input type='radio' name='display_status_option' value='both' checked='true'>
                      Both
                   </input>
                </td>";
    }
    ...
    if ($display_date == "yes") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_date' checked='true' />
                </td>";
    } else {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_date' />
                </td>";
    }
    echo "
                <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>
    ...
    if ($display_time == "yes") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_time' checked='true' />
                </td>";
    } else {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_time' />
                </td>";
    }
    echo "
                <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>
    ...
    if ($display_notes == "yes") {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='checkbox' name='display_notes' checked='true' />
                </td>";
    } else {
        echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
    ...
    echo "
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <textarea name='message_of_the_day' rows='4' cols='35'>$message_of_the_day</textarea>
                </td>
                <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>
	...
	*/
    ...
    $post_use_persistent_connection = $_POST['use_persistent_connection'];
    $post_require_time_admin_edit_reason = $_POST['require_time_admin_edit_reason'];
    ...
    $post_display_status = $_POST['display_status'];
    $post_display_status_option = $_POST['display_status_option'];
    $post_display_date = $_POST['display_date'];
    $post_display_time = $_POST['display_time'];
    $post_display_notes = $_POST['display_notes'];
    $post_message_of_the_day = $_POST['message_of_the_day'];

    $post_email = $_POST['email'];
    $post_date_link = addslashes($_POST['date_link']);
    $post_company_name = addslashes($_POST['company_name']);
    ...
    $post_over_time_hour = $_POST['over_time_hour'];
    ...
    if (($post_use_persistent_connection != '0') && ($post_use_persistent_connection != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>use_persistent_connection</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } else if (($post_require_time_admin_edit_reason != '0') && ($post_require_time_admin_edit_reason != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>require_time_admin_edit_reason</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } else if (($post_use_passwd != '0') && ($post_use_passwd != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>use_passwd</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_use_reports_password != '0') && ($post_use_reports_password != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>use_reports_password</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_restrict_ips != '0') && ($post_restrict_ips != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>restrict_ips</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_disable_sysedit != '0') && ($post_disable_sysedit != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>disable_sysedit</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_user_or_display != '0') && ($post_user_or_display != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>user_or_display</b> does not equal \"user\" or \"display\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_display_ip != '0') && ($post_display_ip != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>display_ip</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_ip_logging != '0') && ($post_ip_logging != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>ip_logging</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_export_csv != '0') && ($post_export_csv != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>export_csv</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_tmp_datefmt != '1') && ($post_tmp_datefmt != '2') && ($post_tmp_datefmt != '3') && ($post_tmp_datefmt != '4') && ($post_tmp_datefmt != '5') && ($post_tmp_datefmt != '6') && ($post_tmp_datefmt != '7') && ($post_tmp_datefmt != '8') && ($post_tmp_datefmt != '9') && ($post_tmp_datefmt != '10') && ($post_tmp_datefmt != '11') && ($post_tmp_datefmt != '12')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>Date Format</b> is not a valid date format.</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_timefmt != '1') && ($post_timefmt != '2') && ($post_timefmt != '3') && ($post_timefmt != '4') && ($post_timefmt != '5') && ($post_timefmt != '6')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>Time Format</b> is not a valid time format.</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif ((!empty($post_round_time)) && ($post_round_time != '1') && ($post_round_time != '2') && ($post_round_time != '3') && ($post_round_time != '4') && ($post_round_time != '5')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>Round a Users Time</b> is not a valid option.</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_use_client_tz != '0') && ($post_use_client_tz != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>use_client_tz</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_use_server_tz != '0') && ($post_use_server_tz != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>use_server_tz</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
...
//    } elseif ((!eregi ("^(#[a-fA-F0-9]{6})+$", $post_color2)) && (!eregi ("^([a-fA-F0-9]{6})+$", $post_color2))) {
        ...
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>display_current_users</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_show_display_name != '0') && ($post_show_display_name != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>show_display_name</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_display_office_name != '0') && ($post_display_office_name != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>display_office_name</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_display_group_name != '0') && ($post_display_group_name != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>display_group_name</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_paginate != '0') && ($post_paginate != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>paginate</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_show_details != '0') && ($post_show_details != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>show_display</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (($post_username_dropdown_only != '0') && ($post_username_dropdown_only != '1')) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>username_dropdown_only</b> does not equal \"yes\" or \"no\".</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
...
//    } elseif ((isset($post_metar)) && (!eregi ("^([a-zA-Z]{4})+$", $post_metar))) {
        ...
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25>The path to your <b>logo</b> is longer than the allowed 200 characters.</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
...
//    } elseif ((!eregi ("^([[:alnum:]]|_|\.|-)+@([[:alnum:]]|\.|-)+(\.)([a-z]{2,4})$", $post_email)) && ($post_email != "none")) {
        ...
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (strlen($post_company_name) > 100) {
        echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
        echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td class=table_rows_red height=25><b>company_name</b> is longer than the allowed 100 characters.</td></tr>\n";
        echo "            </table>\n";
        $evil_post = "1";
        ...
        echo "            </table>\n";
        $evil_post = "1";
    } elseif (!isset($evil_post)) { // All user input is so far valid
...
//           } elseif ((eregi("^([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})$", $post_allowed_networks[$x], $net_regs)) || (eregi("^([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})/([0-9]?[0-9]?[0-9])$", $post_allowed_networks[$x], $net_regs)) || (eregi("^([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})\.\[([0-9]?[0-9]?[0-9])\-([0-9]?[0-9]?[0-9])\]$", $post_allowed_networks[$x], $net_regs)) || (!empty($post_allowed_networks[$x]))) {
                ...
                if (strstr($post_allowed_networks[$x], '/')) {
                    ...
                    if ((($net_regs[1] < '0') || ($net_regs[1] > '255')) || (($net_regs[2] < '0') || ($net_regs[2] > '255')) || (($net_regs[3] < '0') || ($net_regs[3] > '255')) || (($net_regs[4] < '0') || ($net_regs[4] > '255')) || ((isset($net_regs[5])) && (($net_regs[5] < '0') || ($net_regs[5] > '255')))) {
                        $evil_allowed_networks = "1";
                        $evil_post = "1";
                    }
                }
        ...
        if (isset($evil_links)) {
            ...
            echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
            echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td height=25 class=table_rows_red>one of the <b>display_links</b> is more than the allowed 100 characters.</td></tr>\n";
            echo "            </table>\n";
        } elseif (isset($evil_allowed_networks)) {
            echo "            <table align=center class=table_border width=100% border=0 cellpadding=0 cellspacing=3>\n";
            echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td> <td height=25 class=table_rows_red>one of the <b>allowed_networks</b> is not a valid ip address or network.</td></tr>\n";
            echo "            </table>\n";
...
//        } elseif ((!eregi ("^([0-9]?[0-9])+:+([0-9]+[0-9])+([a|p]+m)$", $post_report_end_time, $end_time_regs)) && (!eregi ("^([0-9]?[0-9])+:+([0-9]+[0-9])+( [a|p]+m)$", $post_report_end_time, $end_time_regs)) && (!eregi ("^([0-9]?[0-9])+:+([0-9]+[0-9])$", $post_report_end_time, $end_time_regs))) {
    ...
    if (isset($evil_post)) { // There is something wrong with the users supplied values
        echo "            <br />\n";
        echo "            <table width=100% border=0 cellpadding=0 cellspacing=0>\n";
        echo "              <tr><th colspan=3 class=table_heading_no_color nowrap align=left>Edit System Settings</th></tr>\n";
        echo "              <tr><td colspan=3 class=table_rows width=10% align=left style='padding-left:4px;'>Listed below are the settings that have been chosen within config.inc.php, the config file for WorkTime Control. Edit as you see fit. Then click the \"Next\" button near the bottom of the page to continue.</td></tr>\n";
        ...
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>use_persistent_connection:</td>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        if ($post_use_persistent_connection == "1") {
            echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_persistent_connection\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"use_persistent_connection\" value=\"0\" />&nbsp;No</td>\n";
        } elseif (empty($post_use_persistent_connection)) {
            echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"use_persistent_connection\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"use_persistent_connection\" value=\"0\" checked />&nbsp;No</td>\n";
        } else {
            echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
            echo "              <input type=\"hidden\" name=\"use_persistent_connection\" value=\"2\">\n";
        }
        echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>This provides the option for the users to input their password when individually punching in/out of the timeclock. Default is \"<b>yes</b>\".</td></tr>\n";
        $row_count = '0'; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td nowrap style='border:solid #888888;border-width:0px 0px 1px 0px;' colspan=3>&nbsp;</td></tr>\n";
        ...
        if ($post_disable_sysedit == "1") {
            echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"disable_sysedit\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"disable_sysedit\" value=\"0\" />&nbsp;No</td>\n";
        ...
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>use_persistent_connection:</td>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        if ($post_require_time_admin_edit_reason == "1") {
            echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"1\" checked />&nbsp;Yes<input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"0\" />&nbsp;No</td>\n";
        } elseif (empty($post_require_time_admin_edit_reason)) {
            echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"1\" />&nbsp;Yes<input type=\"radio\" name=\"require_time_admin_edit_reason\" value=\"0\" checked />&nbsp;No</td>\n";
        } else {
            echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Yes\" or \"No\" has not been chosen in config.inc.php</b></td>\n";
            echo "              <input type=\"hidden\" name=\"require_time_admin_edit_reason\" value=\"2\">\n";
        ...
        if (($post_tmp_datefmt != "1") && ($post_tmp_datefmt != "2") && ($post_tmp_datefmt != "3") && ($post_tmp_datefmt != "4") && ($post_tmp_datefmt != "5") && ($post_tmp_datefmt != "6") && ($post_tmp_datefmt != "7") && ($post_tmp_datefmt != "8") && ($post_tmp_datefmt != "9") && ($post_tmp_datefmt != "10") && ($post_tmp_datefmt != "11") && ($post_tmp_datefmt != "12")) {
            echo "              <tr><td colspan=3 valign=bottom height=30 bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>A valid Date Format has not been chosen in config.inc.php!! Choose one from above.</b></td></tr>\n";
        }
        echo "</table></td></tr>\n";
        $row_count = '0'; $row_color = ($row_count % 2) ? $color2 : $color1;
        ...
        if (($post_timefmt != "1") && ($post_timefmt != "2") && ($post_timefmt != "3") && ($post_timefmt != "4") && ($post_timefmt != "5") && ($post_timefmt != "6")) {
            echo "              <tr><td colspan=3 valign=bottom height=30 bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>A valid Time Format has not been chosen in config.inc.php!! Choose one from above.</b></td></tr>\n";
        }
        $row_count = '0'; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td nowrap style='border:solid #888888;border-width:0px 0px 1px 0px;' colspan=3>&nbsp;</td></tr>\n";
        ...
        $row_count++; $row_color = ($row_count % 2) ? $color2: $color1;
        if ((!empty($post_round_time)) && ($post_round_time != '1') && ($post_round_time != '2') && ($post_round_time != '3') && ($post_round_time != '4') && ($post_round_time != '5')) {
            echo "              <tr><td colspan=3 valign=bottom height=30 bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top style='padding-left:5px;'><b>A valid Rounding Method has not been chosen in config.inc.php!! Choose one from above.</b></td></tr>\n";
        }
        echo "            </table></td></tr>\n";
        echo "              <tr><td height=25 valign=bottom colspan=3 class=table_rows width=10% align=left style='padding-left:4px;'> <u>Other Reports Settings:</u></td></tr>\n";
        ...
        echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Choose whether to show the punch-in/out details for each punch for each user on the Hours Worked report or not. Default is \"<b>yes</b>\".</td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>report_start_time:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"10\" maxlength=\"8\" name=\"report_start_time\" value=\"$post_report_start_time\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>These two variables, report_start_time and report_end_time, are designed to work with the Hours Worked report. They are there to provide a starting time to go along with the starting date, and an ending time to go along with the ending date for the dates specified when the report is run. Default is \"<b>00:00</b>\" (12:00am). 12 hour and 24 hour formats are supported. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>report_end_time:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"10\" maxlength=\"8\" name=\"report_end_time\" value=\"$post_report_end_time\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Default is \"<b>23:59</b>\" (11:59pm). 12 hour and 24 hour formats are supported. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>username_dropdown_only:</td>\n";
        ...
        echo "
              <tr>
                ...
                <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>
                   <input type='text' name='over_time_hour' value='$post_over_time_hour' />
                </td>
                <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>
                   The hour after which overtime begins. Setting over_time_hour to zero will disable the feature. Default is \"<b>0</b>\".
                </td>\n";
        ...
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>display_office:</td>\n";
        echo "                     <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <select name='office_name' onchange='group_names();'> //   <option selected>$post_office_name</option>\n";
        echo "                      </select></td>\n";
        echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Display a certain office on the main page of the application, instead of all the users. Default is \"<b>all</b>\". </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>display_group:</td>\n";
        if (($display_office == "all") || ($display_office == "All")) {
            ...
            echo "                     <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top> <select name='group_name' onfocus='group_names();'> <option selected>$post_group_name</option>\n";
            echo "                      </select></td>\n";
        }
        echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Display only a certain group on the main page of the application, instead of a particular office, or all the users. If \"all\" is chosen for the office, then you can choose any group in the list. This is there for if you have 2 or more groups with the same name, but with each having a different parent office. In this case, if you wanted to display all members of the groups with the same name, you could do this without having to choose an office. Default is \"<b>all</b>\".</td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        ...
        echo "                  <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>To display local weather info on the left side of the application just below the submit button, set this to \"yes\". Default is \"<b>no</b>\". </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>metar:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"10\" maxlength=\"4\" name=\"metar\" value=\"$post_metar\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Sets the ICAO (International Civil Aviation Organization) for your local airport. This is the unique four letter international ID for the airport. METAR reports are created at roughly 4500 airports from around the world, so you probably live near one of them. The airports make a report once or twice an hour, and these reports are stored at the National Weather Service and are publicly available via HTTP or FTP. Visit <a href='https://pilotweb.nas.faa.gov/qryhtml/icao/' class=admin_headings style='text-decoration:underline;'> https://pilotweb.nas.faa.gov/qryhtml/icao/</a> to find a corresponding ICAO near you. If 'display_weather' is set to \"no\", this option is ignored. If 'display_weather' is set to \"yes\", you must provide an ICAO here. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        $post_city = stripslashes($post_city);
        $post_city = htmlentities($post_city);
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>city:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"30\" maxlength=\"100\" name=\"city\" value=\"$post_city\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>This is the city and state (or can be city and country, or really can be anything you want) of the airport for the ICAO used above. If 'display_weather' is set to \"no\", this option is ignored. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>links:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>\n";
        for ($x=0;$x<count($post_links);$x++) {
    ...
    echo "
        ...
        echo "              <tr><td nowrap style='border:solid #888888;border-width:0px 0px 1px 0px;' colspan=3>&nbsp;</td></tr>\n";
        echo "              <tr><th colspan=3 class=table_heading_no_color nowrap align=left>Miscellaneous Settings</th></tr>\n";
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>email:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"32\" maxlength=\"100\" name=\"email\" value=\"$post_email\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>This is an email address to display in the footer. Set it to \"none\" to ignore this option. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        $post_date_link = stripslashes($post_date_link);
        $post_date_link = htmlentities($post_date_link);
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>date_link:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"32\" maxlength=\"100\" name=\"date_link\" value=\"$post_date_link\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>If your users click on the displayed date in the top right of the application, they will be taken to this website. Set it to \"none\" to ignore this option. Default is 'This Day in History', <b>http://www.historychannel.com/tdih</b>. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        $post_company_name = stripslashes($post_company_name);
        $post_company_name = htmlentities($post_company_name);
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>company_name:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"25\" maxlength=\"100\" name=\"company_name\" value=\"$post_company_name\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>The name of the company whose hours are being tracked.</td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        $post_app_version = stripslashes($post_app_version);
        $post_app_version = htmlentities($post_app_version);
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>app_version:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"text\" size=\"25\" maxlength=\"100\" name=\"app_version\" value=\"$post_app_version\" /></td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Sets the second half of the 'title' shown below. </td></tr>\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "              <tr><td bgcolor='$row_color' class=table_rows width=10% align=left style='padding-left:4px;' valign=top>title:</td> <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top>$post_company_name Timeclock</td> <td bgcolor='$row_color' class=table_rows width=80% align=left style='padding-left:10px;' valign=top>Sets the title in the header. This is what is displayed in the title bar of your web browser, and it is what the page will be named by default when you make a \"favorite\" or \"bookmark\" in your web browser. </td></tr>\n";
        echo "          </table>\n";
        echo "          <input type=\"hidden\" name=\"title\" value=\"$title\">\n";
        $row_count++; $row_color = ($row_count % 2) ? $color2 : $color1;
        echo "            <table width=100% border=0 cellpadding=0 cellspacing=0>\n";
	...
	include '../theme/templates/adminfooterscripts.inc';
        ...
        if (!empty($post_use_persistent_connection)) {
            $post_use_persistent_connection = "yes";
        } else {
            $post_use_persistent_connection = "no";
        }
        if (!empty($post_require_time_admin_edit_reason)) {
            $post_require_time_admin_edit_reason = "yes";
        } else {
            $post_require_time_admin_edit_reason = "no";
        }
        ...
        if (empty($post_over_time_hour)) {
            $post_over_time_hour = 0;
        }

        if ($post_display_name == "on") {
            $post_display_name = "yes";
        } else {
            $post_display_name = "no";
        }

        if ($post_display_status == "on") {
            $post_display_status = "yes";
        } else {
            $post_display_status = "no";
        }

        if ($post_display_date == "on") {
            $post_display_date = "yes";
        } else {
            $post_display_date = "no";
        }

        if ($post_display_time == "on") {
            $post_display_time = "yes";
        } else {
            $post_display_time = "no";
        }

        if ($post_display_notes == "on") {
            $post_display_notes = "yes";
        } else {
            $post_display_notes = "no";
        }

        if (empty($post_message_of_the_day)) {
            $post_message_of_the_day = "none";
        }
...
/* mysql info
        ...
        --- $db_password is the mysql password for the username to the database.
...
/* If you want to use normal connections to the database instead of persistent connects
   change $use_persistent_connection to "no". The default is "yes". */

$use_persistent_connection = "'. $post_use_persistent_connection .'";


/* If you want a time edit admin to be able to edit times without providing a reason for
the changes change $require_admin_edit_reason to "no". The default is "yes". */

$require_time_admin_edit_reason = "'. $post_require_time_admin_edit_reason .'";
...
/* Sets if the display page should display the status of the users logged in. Default is "yes". */

$display_status = "'. $post_display_status .'";


/* Sets how the display page should display the status of the users logged in. Options are
"icon", "text", or "both". Default is "both". */

$display_status_option = "'. $post_display_status_option .'";


/* Sets if the display page should display the date of the users logged in. Default is "yes". */

$display_date = "'. $post_display_date .'";


/* Sets if the display page should display the time of the users logged in. Default is "yes". */

$display_time = "'. $post_display_time .'";


/* Sets if the display page should display the notes of the users logged in. Default is "yes". */

$display_notes = "'. $post_display_notes .'";
...
$message_of_the_day = "'. $post_message_of_the_day .'";
...
If $cover_time is set to 0 then it disables all overtime calculations. Default is "0" */

$over_time_hour = "'. $post_over_time_hour .'";
...
National Weather Service and are publicly available via HTTP or FTP. Visit
