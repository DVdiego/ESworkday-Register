...
if($request == 'GET'){
  ...
  echo "                  <select class='form-control' name='post_statusname'>
                              <option value =''>
                                ...
                              </option>";
  ...
  echo "             <div class='form-group'>
                       <label>Notes:</label>
                         <input type='text' name='post_notes' maxlength='250' class='form-control'>
                     </div>";
  ...
  if(!isset($evil_post)){
    ...
    if(!isset($office_name,$group_name,$fullname,$post_date)){
       $evil_post = '1';
    }
